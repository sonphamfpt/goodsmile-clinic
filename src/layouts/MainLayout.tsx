...
export const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-on-surface">
      {/* TopNavBar */}
      <header className="bg-surface sticky top-0 z-40 border-b border-outline-variant flex justify-between items-center w-full px-container-padding-desktop py-stack-md">
        <div className="flex items-center gap-stack-md">
          <Link to="/" className="text-headline-md font-headline-md text-primary hover:opacity-95 transition-opacity">
            GoodSmile
          </Link>
          <nav className="hidden md:flex items-center gap-stack-lg ml-stack-lg">
            <Link
              to="/"
              className={`font-label-md text-label-md py-base transition-colors ${
                isActive('/')
        ...
        <div className="flex items-center gap-stack-md">
          {user && (
            <Link
              ...
              className="hidden md:flex items-center text-primary font-bold font-label-md text-label-md px-4 py-2 hover:bg-surface-container-low rounded-lg transition-all"
            >
          ...
          <button
            ...
            className="bg-primary text-on-primary px-6 py-2.5 rounded-lg font-bold font-label-md text-label-md active:scale-95 transition-all shadow-sm"
          >
      ...
      <footer className="bg-surface-container-high px-container-padding-desktop py-stack-lg border-t border-outline-variant mt-auto">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-stack-lg">
          <div className="col-span-1 md:col-span-2">
            <span className="text-headline-md font-headline-md text-primary">GoodSmile</span>
          ...
          <div>
            ...
            <ul className="space-y-base text-body-md font-body-md text-on-surface-variant">
              <li className="hover:text-primary cursor-pointer transition-colors">Bảng giá gói dịch vụ</li>
